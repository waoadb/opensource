    ...
    <div className="container mx-auto my-10 lg:my-20">
      <div className="flex flex-row flex-wrap justify-between items-center gap-4">
        <div className="w-full lg:w-auto lg:basis-3/4">
          <Button onClick={() => setMobileFilters(!mobileFilters)} className="w-full lg:hidden" variant="hollowPrimary" icon={<Icon name="Filter" width="18" height="18" />}>Filter</Button>
          <div className={` ${filtersOnMobile(mobileFilters)}`}>
            <div className="grid lg:grid-cols-4 gap-4 mt-4 lg:mt-0">
              ...
              <Select id='access' labelClassName="col-span-1" onChange={handleOnSelect} options={[{text: 'Free', value: 'free'}, {text: 'Paid', value: 'paid'}]} placeholder="Access" icon={<Icon name="Person" width="18" height="18"/>} />
            </div>
          </div>
        </div>
