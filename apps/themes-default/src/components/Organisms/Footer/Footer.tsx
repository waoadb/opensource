    ...
    <footer className="bg-gray-200 block w-full">
      <div className="container mx-auto py-10">
              ...
              <ul className="lg:mt-2 flex flex-row flex-wrap gap-2">
                <li>
                  <Link
                    ...
                    className="inline-flex items-center justify-center bg-white rounded-full w-8 h-8 group hover:bg-indigo-600 transition-colors"
                  >
                    <Icon
                      name="FacebookCircle"
        ...
        <div className="flex flex-col gap-4 mb-4 lg:flex-row items-center justify-between">
          <Paragraph
            variant="small"
            className="inline-flex items-center gap-2 order-3 lg:-order-1"
          >
            <Image
          ...
          <div className="order-2">
            <Paragraph variant="small" className="opacity-90">
