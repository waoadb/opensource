...
type Props = {
   ...
   */
  onSubmit: (
    payload: Omit<ClientCacheModels.RetrieveEventListRequest, 'limit' | 'skip'>
  ) => void;
};
 ...
 * @returns
 */
export const WhatsOnFilters = ({ onSubmit, view, handleViewChange }: Props) => {
  // State
            ...
            {({
              ...
              >
                ...
                <div className="w-full self-end grid grid-cols-2 gap-2 md:gap-4 lg:gap-1 lg:max-w-[168px] border-b md:border-none border-gray-500 border-solid pb-8 md:pb-0">
                  <Button
                    accessibleTitle="Apply filters to available events"
                    type="submit"
                    variant="primary"
