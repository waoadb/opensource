...
export class ToolTip extends React.Component<ToolTipProps> {
  ...
  public render(): JSX.Element {
    return (
      <div className="tool-tip w-auto" ref={this.componentRef}>
        <button
        ...
        <div
          className="tool-tip__message bg-white hidden rounded-3 border border-black border-solid px-1 z-2 py-1 min-w-60"
          data-tool-tip-message
          id={this.props.id}
          role="tooltip"
        >
