        ...
        <div className="mx-auto container">
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="col-span-2 md:col-span-1">
              <Image src="https://picsum.photos/1024/780/" alt="" width={1024} height={780} />
            </div>
            <div className="col-span-2 md:col-span-1">
              <SupportDetails />
        ...
        <div className='mx-auto container my-10 lg:my-20'>
          <div className='grid grid-cols-1'>
            <div className='col-span-1'>
              <Heading level="h3" className="text-indigo-700"><span className="inline-block border-b-2 border-b-current">What&apos;s on</span></Heading>
              <WhatsOnFilters view="list" setView={() => setView(view === 'calendar' ? 'list' : 'calendar')} />
