...
- [Event Information] - We provide event details, including SEO, refund policy, and much more.
- [Venue Information] - We provide venue details.
- [Profile Information] - We provide profile details, including support details.
- [Performance Information] - We provide performance details.
- [Tickets & Addons] - We provide stock information for an event performance.
- [Cart Provider] - We provide an API-driven cart for you to use.
...
<img src="/getting-started/stand-alone.jpg" alt="Stand alone solution example" width="100%" height="auto"/>
...
<img src="/getting-started/composable.jpg" alt="Composable solution example" width="100%" height="auto"/>
