    ...
    <>
      ...
      <Layout>
        <div className='container mx-auto my-10 lg:my-20'>
          <Heading level='h1' className='mb-8'>Checkout - Attendee Details</Heading>
          <div className='grid grid-cols-1 md:grid-cols-8 gap-4'>
            <div className='col-span-1 md:col-span-5 lg:col-span-4'>
              <form onSubmit={checkoutHandler}>
                <div className='mb-4'>
                  <Heading level='h3' style='h3'>Main contact</Heading>
                  <fieldset className='grid grid-cols-2 gap-4'>
                    ...
                    <div className='col-span-1'>
                      <Input
                        ...
                        inputClassName='placeholder:text-white' onChange={() => {
                      }} />
                    </div>
                    <div className='col-span-1'>
                      <Input
                        ...
                        <>
                          <Disclosure.Button className='py-2 font-semibold relative block w-full text-lg text-left'>
                            ...
                            <span className='absolute right-0 top-1/2 -translate-y-1/2'>
                                <Icon name='ChevronDown' width='22' height='22'
                          ...
                          <Transition
                            ...
                            <Disclosure.Panel>
                              <div className='bg-indigo-200 p-4 rounded-md'>
                                <Paragraph className='mb-2'>Performance: Mon 01 May 2023 - 21:00pm</Paragraph>
                                <div className='mb-4'>
                                  <Heading level='h5' className='text-indigo-700 mb-4'><span
                                    className='inline-block border-b-2 border-b-current'>General Admission</span></Heading>
                                  ...
                                  <fieldset className='grid grid-cols-2 gap-4 mb-4'>
                                    <legend className='font-semibold mb-2'>Billing Address</legend>
                                    <div className='col-span-2'>
                                      <Input
                                        id={`e${i}_address1`}
                                        name={`e${i}_address1`}
                                ...
                                <div className='mb-4'>
                                  <Heading level='h5' className='text-indigo-700 mb-4'><span
                                    className='inline-block border-b-2 border-b-current'>Student</span></Heading>
                                  <fieldset className='grid grid-cols-11 gap-4 mb-4'>
                                    <div className='col-span-3'>
                                      <Input
                                        id={`st${i}_title`}
                                ...
                                <div className='mb-4'>
                                  <Heading level='h5' className='text-indigo-700 mb-4'><span
                                    className='inline-block border-b-2 border-b-current'>Delivery</span></Heading>
